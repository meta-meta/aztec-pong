...
class Scene extends React.Component {
  render () {
    ...
    return (
        <Entity>
          <Entity position={`${this.props.player === '1' ? -11 : 11} 0.5 0`}
                  rotation={`0 ${this.props.player === '1' ? -90 : 90} 0`}>
            <Entity ref="camera" camera wasd-controls no-click-look-controls={{maxyaw: 1.5}}>
              <Cursor />
            </Entity>
          </Entity>
          <Sky/>
